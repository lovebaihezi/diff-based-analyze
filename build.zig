...
pub fn build(b: *std.Build) void {
    ...
    exe.linkSystemLibrary2("clangTooling", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangFrontend", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangFrontendTool", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangDriver", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangSerialization", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangCodeGen", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangParse", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangSema", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangStaticAnalyzerFrontend", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangStaticAnalyzerCheckers", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangStaticAnalyzerCore", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangAnalysis", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangARCMigrate", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangRewrite", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangRewriteFrontend", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangEdit", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangAST", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangLex", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("clangBasic", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("LLVMCore", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("LLVMCodeGen", .{ .preferred_link_mode = .dynamic, .needed = true });
    exe.linkSystemLibrary2("LLVMSupport", .{ .preferred_link_mode = .dynamic, .needed = true });

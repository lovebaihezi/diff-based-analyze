...
inline auto make_printf_args(T &...args)
    -> decltype(fmtquill::make_format_args<basic_printf_context<Char>>(
        args...)) {
  return fmtquill::make_format_args<basic_printf_context<Char>>(args...);
}
...
template <typename Char>
FMTQUILL_DEPRECATED inline auto
